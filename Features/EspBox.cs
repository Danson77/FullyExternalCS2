...
public static class EspBox
{
    ...
    //private static void DrawWeaponName(Graphics.Graphics graphics, (Vector2, Vector2) boundingBox, string currentWeaponName)
    //{
    //    if (string.IsNullOrEmpty(currentWeaponName)) currentWeaponName = "NONE";
    //
    //    Color weaponNameColor = GetWeaponNameColor(currentWeaponName);
    //    Color outlineColor = Color.Black;
    //
    //    var textWidth = graphics.FontConsolas32.MeasureText(null, currentWeaponName, FontDrawFlags.Center).Right + 30;
    //    var weaponNamePosition = new Vector2((boundingBox.Item1.X + boundingBox.Item2.X - textWidth) / 2, boundingBox.Item2.Y + 5f);
    //
    //    int outlineOffset = 1; // Outline thickness
    //
    //    // Draw outline behind text
    //    graphics.FontConsolas32.DrawText(default, currentWeaponName, (int)weaponNamePosition.X - outlineOffset, (int)weaponNamePosition.Y, outlineColor);
    //    graphics.FontConsolas32.DrawText(default, currentWeaponName, (int)weaponNamePosition.X + outlineOffset, (int)weaponNamePosition.Y, outlineColor);
    //    graphics.FontConsolas32.DrawText(default, currentWeaponName, (int)weaponNamePosition.X, (int)weaponNamePosition.Y - outlineOffset, outlineColor);
    //    graphics.FontConsolas32.DrawText(default, currentWeaponName, (int)weaponNamePosition.X, (int)weaponNamePosition.Y + outlineOffset, outlineColor);
    //
    //    // Draw main text
    //    graphics.FontConsolas32.DrawText(default, currentWeaponName, (int)weaponNamePosition.X, (int)weaponNamePosition.Y, weaponNameColor);
    //}

    //private static Color GetWeaponNameColor(string weaponName)
    //{
    //    if (string.IsNullOrWhiteSpace(weaponName)) return Color.White;
    //
    //    // Clean up the weapon name
    //    weaponName = weaponName.Trim().ToLower();
    //
    //    switch (weaponName)
    //    {
    //        // Utility
    ...
    //        case "knifegg":
    //        case "knife_t":
    //            return Color.LightBlue; // Standard knives
    //
    //        case "knife_flip":
    //        case "knife_karambit":
    ...
    //        case "knife_ursus":
    //            return Color.DarkGreen; // Special knives
    //
    ...
    //            return Color.Gold; // Rare or special knives
    //
    //        // Pistols (Low Damage)
    //        case "glock":
    //        case "p250":
    ...
    //
    //        // High-damage weapons (Snipers, Heavy)
    //        case "awp":
    //        case "g3sg1":
    //        case "scar20":
    //            return Color.Gold;
    ...
    //
    //        default:
    //            return Color.White; // Default color for unknown weapon names
    //    }
    //}
